...
public class Sample_iOS_BrowserStack {
    AppiumDriver driver;
    ...
    public void setUp() throws MalformedURLException, UnirestException {
       ...
       // JSONObject appurlObj = new JSONObject(HttpHelper.uploadApp(upploadUrl,System.getProperty("user.dir")+"/apps/<apk>"));
        ...
        JSONObject deviceObj = new JSONObject(JsonReader.parse(System.getProperty("user.dir")+"/src/main/resources/configs/browserStack.json")).getJSONObject("2");
